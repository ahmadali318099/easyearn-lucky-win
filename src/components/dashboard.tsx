...
export function Dashboard() {
  ...
  const quickActions = [
    ...
    {
      title: "View Tasks",
      description: user?.hasDeposited ? "Complete tasks to earn" : "Deposit $10 to unlock",
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-orange-700">Make a minimum deposit of $10 to unlock task earning features.</p>
                </div>
              </div>
              <Link to="/deposit">
